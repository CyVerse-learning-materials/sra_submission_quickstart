...
5. Click 'Launch Analysis' to begin the validation, and click on **Analyses**
   ...
   name to view results. The App will generate two folders:
     ...
     - A folder with your username and a long alphanumeric string.  This folder
       ...
       these errors (see tip below) and resave the metadata file (see `IV. Generate summary metadata file <https://cyverse-sra-submission-quickstart.readthedocs-hosted.com/en/latest/step2.html#iv-generate-summary-metadata-file>`_).
